...
<ul>
<li><strong><a href="security/pre-ws-aa.php">Pre-Web Services Authentication and Authorization</a></strong> - A non-Web services implementation of the Grid Security Infrastructure (GSI), containing the core libraries and tools needed to secure applications using GSI mechanisms</li>
<li><strong><a href="security/ws-aa.php">Web Services Authentication and Authorization</a></strong> - A Web services implementation of the Grid Security Infrastructure (GSI), containing the core libraries and tools needed to secure applications using GSI mechanisms</li>
</ul>
