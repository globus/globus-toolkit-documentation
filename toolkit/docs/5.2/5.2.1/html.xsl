...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <xsl:template match="replaceable[@role='entity']">
                  <xsl:choose>
                                   <xsl:when test=". = 'version'">5.2.1</xsl:when>
                                  <xsl:when test=". = 'shortversion'">5.2</xsl:when>
                                  <xsl:when test=". = 'previousversion'">5.2.0</xsl:when>
                                 <xsl:otherwise>
                ...
                <xsl:param name="target.database.document">/mcs/globus.org/toolkit/docs/5.2/5.2.1/olinkdb.xml</xsl:param> 
                <!-- local to doc coordinator: 
                                <xsl:param name="target.database.document">/Users/cristinawilliams/testing/alliance/toolkit/docs/5.2/5.2.1/olinkdb.xml</xsl:param> -->
                ...
                <xsl:template name="chunk-element-content">
                                ...
                                <html>
                                                ...
                                                <body>
                                                               ...
                                                               <xsl:processing-instruction name="php">
                                                                                include_once("/mcs/globus.org/toolkit/docs/5.2/5.2.1/includes/docbook_drafts.inc");
                                                                                ?</xsl:processing-instruction> 
                                                                -->
