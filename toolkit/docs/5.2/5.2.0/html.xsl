...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <xsl:param name="target.database.document">/mcs/globus.org/toolkit/docs/5.2/5.2.0/olinkdb.xml</xsl:param> 
                <!-- local to doc coordinator: 
                                <xsl:param name="target.database.document">/Users/cristinawilliams/testing/alliance/toolkit/docs/5.2/5.2.0/olinkdb.xml</xsl:param> -->
                                ...
                                <html>
                                                ...
                                                <body>
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                ...
                                                                                include_once("/mcs/globus.org/toolkit/docs/5.2/5.2.0/includes/docbook_obsolete.inc");
