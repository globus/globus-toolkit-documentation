                                ...
                                <html>
                                                ...
                                                <body>
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                include_once("http://www-testing.globus.org/toolkit/docs/4.0/includes/globus_header_docbook.inc");
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                include_once("http://www-testing.globus.org/toolkit/docs/4.0/includes/globus_footer_docbook.inc");
                                                                                ?</xsl:processing-instruction>
