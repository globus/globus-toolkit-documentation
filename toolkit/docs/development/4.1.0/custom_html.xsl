                                ...
                                <html>
                                                ...
                                                <body>
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                include_once("http://www.globus.org/toolkit/docs/development/4.1.0/includes/globus_header_docbook.inc");
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                include_once("http://www.globus.org/toolkit/docs/development/4.1.0/includes/globus_footer_docbook.inc");
                                                                                ?</xsl:processing-instruction>
