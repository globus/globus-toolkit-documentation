                                ...
                                <html>
                                                ...
                                                <body>
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                include_once("http://www.globus.org/toolkit/docs/4.2/4.2.0/includes/globus_header_docbook_releasenotes.inc");
                                                                ...
                                                                <xsl:processing-instruction name="php">
                                                                                include_once("http://www.globus.org/toolkit/docs/4.2/4.2.0/includes/globus_footer_docbook_releasenotes.inc");
                                                                                ?</xsl:processing-instruction>
