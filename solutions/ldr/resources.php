...
Globus Toolkit, omponents that are not yet part of the Toolkit, and other
...
<tr>
<td class="tablekey">Replica Location Service (RLS)</td>
<td>The RLS service and related tools are available in the Globus Toolkit 4.0:
...
<td>The rest of the LDR components and documentation are available from the LDR website, at <a href="http://www.lsc-group.phys.uwm.edu/LDR/">http://www.lsc-group.phys.uwm.edu/LDR/</a>. 
Note that <em>all</em> of the LDR components (including those listed separately above) can
be installed together using PACMAN caches maintained by the LDR development team.</td>
</tr>
</table>
