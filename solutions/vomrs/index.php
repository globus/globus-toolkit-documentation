...
<p>
Developed within the high-energy physics community, VOMRS extends the existing 
<a href="<?=$SITE_PATHS["WEB_SOFTWARE"]."security/voms.php"; ?>">VOMS</a> system to include an 
easy-to-use interface for users to register with the system and request sign-in credentials. Although 
very similar to the <a href="<?=$SITE_PATHS["WEB_SOLUTIONS"]."purse/"; ?>">PURSE</a> solution, VOMRS's 
further integration with the VOMS component adds authorization features in addition to 
