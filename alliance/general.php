...
$title = "Globus: Frequently Asked Questions (The Globus Alliance)";
...
<h1>The Globus Alliance: Frequently Asked Questions</h1>
<ol>
...
<p>Two papers that provide overviews of Grid computing are <i><a href="http://www.globus.org/research/papers.html#anatomy"> Anatomy of the Grid</a></i>,
    ...
    technologies; and <i><a href="http://www.globus.org/research/papers.html#OGSA"> Physiology of the Grid</a></i>,
...
<p>Yes, there is!  A list of major terminology and acronyms used on the Globus 
   Alliancewebsite is available at 
    <a href="site-index.html">http://www-unix.globus.org/r3/site-index.html</a>.</p>
...
<ul>
    <li>The Java CoG Kit (<a href="http://www.globus.org/cog/">http://www.globus.org/cog/</a>) provides access to Grid 
...
Toolkit's <a href="http://www.globus.org/mds/"> MDS</a> (Monitoring and Discovery Service).  Specifically, a Grid Index 
...
some other mechanism, though.</p>
    ...
    <p>ISI runs a <a href="http://www.globus.org/mds/getmdsdata/vo-index.html"> public GIIS</a> that allows anyone to register their resources or 
