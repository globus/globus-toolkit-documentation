...
<div id="main">
 ...
 <h1>Index of Globus Alliance Terms</h1>
   
    <p>The following material may be useful as an index to relevant information
    on the Globus Alliance website.  It may also serve as a guide to acronyms used
    on this site and elsewhere in the Globus Alliance and Globus Toolkit.</p>
    
    <p>Please send suggestions for additions or corrections to <a href="mailto:webmaster@globus.org">webmaster@globus.org</a>.</p>
...
<!-- <a href="../research/applications/"> Applications</a><br>-->
<a name="Argonne National Laboratory" href="http://www.anl.gov/">Argonne National Laboratory</a></p>
...
<!-- Computational Grid - <i>see <a href="#Grid"> Grid</a></i><br>-->
    ...
    Condor Project</a><br>
    <a href="http://www.cs.wisc.edu/condor/condorg/">

    Condor-G</a><br>
    <a href="contacts.php">
    Contacts or Contact Information</a><br>
    Contributors - <i>see <a href="#Globus Toolkit Contributors"> Globus Toolkit Contributors</a></i><br>
    <!--CORBA - <i>see <a href="#Common Object Request Broker Architecture"> Common Object Request Broker Architecture</a></i>--></p>
...
<a href="gridware/monitoring/esg-monitoring.php">Earth System Monitoring Tools</a><br>
    ...
    <a href="alliance/activities/meetings.php" name="Events">
    Events</a></p>
    
    <h1><a name="F">F</a></h1>

    <p>FAQ - <i>see <a href="#Frequently Asked Questions"> Frequently Asked Questions</a></i><br>
    <a name="Frequently Asked Questions" href="faq.php">Frequently Asked Questions</a><br>
    Funding - <i>see <a href="#Sponsors"> Sponsors</a></i><br>
...
<a href= "gridware/monitoring/ganglia.php"> Ganglia Cluster Toolkit </a><br>
   ...
   <!-- GIS - <i>see <a href="#Grid Information Services"> Grid Information Services</a></i><br>-->
    ...
    Globus Toolkit Public License</a><br>-->
    GPT - <i>see <a href="#Grid Packaging Technology"> Grid Packaging Technology</a></i><br>
...
<a href="gridware/computation/gridant.php">GridAnt</a><br>
    ...
    Grid Information Protocol</a><br>
    <a name="Grid Packaging Technology" href="http://www.ncsa.uiuc.edu/Divisions/ACES/GPT/">
    Grid Packaging Technology</a><br>
    <a name="Grid Registration Protocol" href="alliance/activities/papers/MDS-HPDC.pdf">
...
<a href="gridware/data/scp.php">GSI-SCP/SFTP</a><br>
    ...
    <!--GTPL - <i>see <a href="#Globus Toolkit Public License"> Globus Toolkit Public License</a></i></p>-->
    
    <h1><a name="H">H</a></h1>
<p>
    <a href="http://www.hpclab.niu.edu/"> High Performance Computing Laboratory Northern Illinois University </a> 
</p>
    ...
    <h1><a name="J">J</a></h1>
    <p>
    Jobs - <i>see <a href="#Employment Opportunities"> Employment Opportunities</a></i></p>
    ...
    <a name="Lightweight Directory Access Protocol" href="alliance/activities/papers/MDS-HPDC.pdf">
...
<a href="http://www3.niu.edu/mpi/"> MPICH-G2</a><br>
    ...
    <h1><a name="N">N</a></h1>
    <p><a name="National Computational Science Alliance" href="http://www.ncsa.uiuc.edu/About/Alliance/">National Computational Science Alliance</a><br>
    <a name="National Partners in Advanced Computational Infrastructure" href="http://www.npaci.edu/">
...
<a href="gridware/data/stripedftp.php">Striped GridFTP Service</a><br>
    ...
    <h1><a name="T">T</a></h1>
    <p><a href="alliance/participants.php">Team Members</a><br>
    Technical Papers - <i>see <a href="#Research Papers"> Research Papers</a></i><br>

    <a name="Technical Support" href="contacts.php">Technical Support</a><br>
    Training - <i>see <a href="#Events"> Events</a> </i><br>
    Tutorials - <i>see <a href="#Events"> Events</a> </i></p>
